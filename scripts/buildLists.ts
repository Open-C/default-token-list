...
const LOGO_URI_BASE =
  "https://raw.githubusercontent.com/Open-C/default-token-list/master";
...
const main = async () => {
  ...
  await fs.writeFile(
    __dirname + "/../centro.token-list.json",
    JSON.stringify(tokenList, null, 2)
  );

  await fs.writeFile(
    __dirname + "/../centro-experimental.token-list.json",
